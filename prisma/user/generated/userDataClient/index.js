...
const config = {
  generator: {
    ...
    output: {
      value:
        "C:\\Users\\zmwps\\OneDrive\\바탕 화면\\NodeJSWorkspace\\futsalOnline\\prisma\\user\\generated\\userDataClient",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
...
if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
  const alternativePaths = ["generated/userDataClient", "userDataClient"];
...
path.join(
  process.cwd(),
  "generated/userDataClient/query_engine-windows.dll.node",
);
...
path.join(
  process.cwd(),
  "generated/userDataClient/libquery_engine-debian-openssl-3.0.x.so.node",
);
// file annotations for bundling tools to include these files
